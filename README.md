...
```
☝️ Note that fully transparent navigation bar can cause contrast issues to the navigation icons for API level `[23..29)`. Check [Navigation Bar Transparency](https://github.com/beworker/edge-to-edge/wiki/Navigation-Bar-Transparency) wiki page for more details.
